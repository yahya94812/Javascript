...
// why callback?, ans: callback is usually handover to asynchronous functions to be executed after the asynchronous operation is completed to process the result of that operation.
